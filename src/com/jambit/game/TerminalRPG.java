    ...
    public void miniMenu() {
        ...
        switch (input) {
            case "1":
                ...
                Terminal.println("Congratulations you have opened the locked door, now you step into a big room that looks like a reception");
                player.changeLevel(reception);
                break;
            case "2":
                Terminal.println("You look around you and you see the key-card-scanner from before, 3 locked doors and 2 elevator entrances but nothing is useful for you");
                miniMenu();
                break;
            default:
                break;
